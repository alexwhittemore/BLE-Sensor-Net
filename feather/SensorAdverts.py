...
# Mostly repurposed from Adafruit's BLE RGB Color advertisement example
# https://github.com/adafruit/Adafruit_CircuitPython_BLE/blob/main/adafruit_ble/advertising/adafruit.py

_MANUFACTURING_DATA_ADT = const(0xFF)
_MY_COMPANY_ID = const(0x14B5)
